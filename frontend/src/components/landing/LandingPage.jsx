    ...
    <>
      ...
      <div className="relative min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center px-6 overflow-hidden">
        ...
        <div className="relative z-[10] flex flex-col items-center">
          ...
          >
            Connect <span className="text-white font-semibold">Students</span> with
          ...
          {!(token && role) ? (
            ...
            >
              <button
                ...
                className="bg-red-600 hover:bg-red-700 px-8 py-3 rounded-xl text-lg font-semibold transition transform hover:scale-105 shadow-xl shadow-red-900/40 cursor-pointer"
              >
                Login
              </button>
              ...
              <button
                ...
                className="bg-gray-800 border border-red-600 hover:bg-red-700 hover:border-red-700 px-8 py-3 rounded-xl text-lg font-semibold transition transform hover:scale-105 cursor-pointer"
              >
                Register
              </button>
            </motion.div>
