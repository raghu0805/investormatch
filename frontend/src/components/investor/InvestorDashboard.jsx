    ...
    <div className="min-h-screen bg-gray-900 text-white p-6">
      <div className="max-w-3xl mx-auto">
        ...
        {!profile && (
          <div className="text-center mt-20 bg-gray-800 p-8 rounded-2xl shadow-2xl">
            ...
            <button
              ...
              className="px-6 py-3 bg-blue-600 hover:bg-blue-700 rounded-xl text-lg font-semibold cursor-pointer"
            >
        ...
        {profile && (
          <div className="bg-gray-800 p-8 rounded-2xl shadow-2xl">
            ...
            <button
              ...
              className="mt-6 w-full bg-blue-600 py-3 rounded-lg hover:bg-blue-700 text-white font-semibold cursor-pointer"
            >
              Edit Profile
            </button>
          </div>
        ...
        <div className="bg-gray-800/60 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-gray-700 mt-8">
          <h2 className="text-2xl font-semibold mb-4">Find Matching Students / Projects</h2>
          <p className="mb-4">
            View student projects matched using industry, funding, location, and stage.
          </p>
          <button
            onClick={() => navigate("/investor/matched-students")}
